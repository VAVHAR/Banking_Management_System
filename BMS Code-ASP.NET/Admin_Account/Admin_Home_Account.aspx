<%@ Page Language="C#" MasterPageFile="~/Admin_Account/Welcome_To_Admin_Account.master" AutoEventWireup="true" CodeFile="~/Admin_Account/Admin_Home_Account.aspx.cs" Inherits="Admin_Home" Title="Untitled Page" %>
    ...
    <table class="style1">
        <tr>
            <td 
                ...
                <marquee behavior="alternate" direction="right">Admin Home Account</marquee></td>
        </tr>
        <tr>
                ...
                <table class="style1">
                    <tr>
                        <td class="style13">
                            ...
                            your own business and require a robust banking partner, HSK bank not only 
